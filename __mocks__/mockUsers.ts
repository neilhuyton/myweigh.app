...
export const mockUsers: MockUser[] = [
  ...
  },
  {
    ...
    password: bcrypt.hashSync('password123', 10),
    isEmailVerified: true, // For already verified test
    verificationToken: '987fcdeb-12d3-4e5a-9876-426614174000', // Unique token for verified user
    resetPasswordToken: null,
    resetPasswordTokenExpiresAt: null,
  ...
  },
  {
    ...
    verificationToken: "42c6b154-c097-4a71-9b34-5b28669ea467", // For valid token tests
    isEmailVerified: false, // For successful verification
