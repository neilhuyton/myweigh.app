...
describe('ResetPasswordForm Component', () => {
  ...
  it('submits email and displays success message with form reset', async () => {
    ...
    fireEvent.change(emailInput, { target: { value: 'neil.huyton@gmail.com' } });
  ...
  it('displays error message when email is not found', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByRole('alert')).toHaveTextContent('Failed to send reset link: Email not found');
    }, { timeout: 5000 });
  });
});